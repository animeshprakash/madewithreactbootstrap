        ...
        return (
            <Container>
                <Row className="justify-content-end">
                    <Col md={5} xs={12}><h1><b><span style={{color:'white'}}>UI/UX</span> with <span style={{color:'white'}}>Figma</span></b></h1></Col>
                </Row>
                <Row className="justify-content-end">
                    <Col md={5} xs={12}>
                ...
                <Row style={{marginTop: '5%'}} className="justify-content-end">
                    <Col md={5} xs={12}><h2 style={{color:'white'}}><b><i className="far fa-calendar"></i> 22<sup>nd</sup> November 2020</b></h2></Col>
                </Row>
            </Container>
        );
}